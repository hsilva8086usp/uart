...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KINETIS_FLASH_CONFIG_FOPT, 0x3B);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_ADC16_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_GPIO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_I2C_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_LPSCI_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_MCG_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_SIM_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_FRDM_KL25Z_MKL25Z4, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_MCUX_LPSCI, 1);
